...
# WZ: Skip coping the DRB5_gen.txt in Kourami installation folder to custom folder
#     The old version of DRB5_gen.txt is incompitable with new IMGT/HLA database
