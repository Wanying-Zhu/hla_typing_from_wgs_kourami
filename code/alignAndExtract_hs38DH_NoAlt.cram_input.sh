...
function usage {
    ...
    echo
    echo " cram_path          : sorted and indexed cram to hs38NoAltDH (ex: NA12878.bam) [required]"
    echo
    echo " cram_ref          : Reference for the cram file [required]"
    echo
...
if [ ! -e "$cram_path" ] || [ ! -e "$kourami_db" ] || [ ! -e "$merged_hla_panel" ];then
...
$samtools_bin view -b -T ${cram_ref} ${cram_path}  chr6:29723340-29727296 chr6:29726601-29749049 chr6:29826979-29831122 \
